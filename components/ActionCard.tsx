...
export function ActionCard({ item }: { item: ActionItem }) {
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-2 sm:gap-3 rounded-lg border border-gray-200 bg-gray-100 p-2.5 sm:p-3 transition-colors hover:border-gray-300 hover:bg-gray-100 min-w-0"
    >
      <div
        className={clsx(
