        ...
        <div className="rounded-xl border border-brand-500/30 bg-brand-500/5 p-6">
          ...
          <ul className="mt-4 space-y-3">
            {aiInsights.slice(0, 2).map((insight) => (
              <li key={insight.id} className="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-3">
                <span className="text-sm text-gray-800">{insight.title}</span>
