    ...
    <div className="space-y-6 sm:space-y-8 animate-fade-in min-w-0 max-w-full">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-surface-700 bg-surface-900/50 p-6">
          ...
          <div className="rounded-xl border-2 border-surface-600 bg-surface-800/50 p-6 max-w-sm">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-surface-400 truncate">{company}</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-surface-600 bg-surface-800 px-4 py-2.5 text-sm text-white focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
              />
            </div>
            <div>
